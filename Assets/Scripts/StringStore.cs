...
public class StringStore
{
    ...
    public static string ModelImageSuffix = "Model";
    ...
    // ---------- Reference Image Link to the Cloud --------------
    public static string BeeImage =
        "https://firebasestorage.googleapis.com/v0/b/mkebliv-4057f.appspot.com/o/ReferenceImages%2FBeeImage.jpg?alt=media&token=ca96110f-6742-4bb1-a386-801620d82845";

    public static string BasketballImageWhite = "https://firebasestorage.googleapis.com/v0/b/mkebliv-4057f.appspot.com/o/ReferenceImages%2Fbasketballchampion.jpg?alt=media&token=84f60f53-7ec0-417b-8eba-f7366817a71c";
    ...
    // -------- Cloud Storage 3D Model links --------------

    public static string BeeFbxLink =
        "https://firebasestorage.googleapis.com/v0/b/mkebliv-4057f.appspot.com/o/Models%2FBee%20.fbx?alt=media&token=7ca9c51d-e8eb-4417-a15b-7aae9a0b2d1f";

    public static string BeeGlbLink = "https://firebasestorage.googleapis.com/v0/b/mkebliv-4057f.appspot.com/o/Models%2Fbee_3d.glb?alt=media&token=7c616d0b-cbc4-424e-812e-a0f6e14f8162";
